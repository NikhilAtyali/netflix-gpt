      ...
      <div className="pt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        {loading && (
          <div className="flex justify-center items-center py-20">
            <div className={`${theme === 'dark' ? 'text-white' : 'text-gray-900'} text-xl`}>Searching...</div>
          </div>
        )}
        ...
        {!loading && results.length === 0 && (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <h2 className={`text-2xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-2`}>No results found</h2>
            <p className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} text-center max-w-md`}>
